def winMetaDataDiff():
    ...
    df_forLoop= pd.read_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/metaDataDiff_pop.csv')
    ...
    df_metaData.to_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/metaDataDiff.csv', encoding='utf-8', index=False)
winMetaDataDiff()