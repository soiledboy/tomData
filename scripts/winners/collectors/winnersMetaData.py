def winMetaData():
    ...
    df_forLoop= pd.read_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/metaData_popCollector.csv')
    ...
    df_metaData.to_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/metaDataCollector.csv', encoding='utf-8', index=False)