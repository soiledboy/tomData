def concatAllTimeToday():
    ...
    df_newToday = pd.read_csv("/home/tier1marketspace/youtuberReport/scripts/data/winners_todayCollector.csv")
    df_allTime = pd.read_csv("/home/tier1marketspace/youtuberReport/scripts/data/winners_total2Collector.csv")
    ...
    df_winners_final.to_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/winners_finalCollector.csv',date_format='%Y-%m-%d', encoding='utf-8', index=False)
