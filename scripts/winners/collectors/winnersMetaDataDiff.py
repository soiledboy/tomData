def winMetaDataDiff():
    ...
    df_forLoop= pd.read_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/metaDataDiff_popCollector.csv')
    ...
    df_metaData.to_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/metaDataDiffCollector.csv', encoding='utf-8', index=False)