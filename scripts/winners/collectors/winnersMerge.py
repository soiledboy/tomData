def winMerge():
    import pandas as pd
    import numpy as np
    df1 = pd.read_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/winners_totalCollector.csv')
    df2 = pd.read_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/metaDataCollector.csv')
    ...
    df4.to_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/winners_total2Collector.csv', encoding='utf-8', index=False)
