def loseMetaData():
    ...
    df_forLoop= pd.read_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/losersmetaData_popMeta.csv')
    ...
    df_metaData.to_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/losersmetaDataMeta.csv', encoding='utf-8', index=False)