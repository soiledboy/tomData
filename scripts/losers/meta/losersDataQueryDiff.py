def loseDataDiff():
    ...
    import pandas as pd
    from queries.queryLine_losediff import query07
    from queries.queryLine_losediff import query30
    from queries.queryLine_losediff import query90
    from queries.queryLine_losediff import query180
    # 7 days
    ...
    df_lose.to_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/losers_totalDiffMeta.csv', encoding='utf-8', index=False)

    df_newActivity = df_lose.drop_duplicates(subset='tcg_product_id', keep='first')
    df_newActivity.to_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/losersmetaDataDiff_popMeta.csv', encoding='utf-8', index=False)
