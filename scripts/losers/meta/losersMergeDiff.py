def loseMergeDiff():
    import pandas as pd
    df1 = pd.read_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/losers_totalDiffMeta.csv')
    df2 = pd.read_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/losersmetaDataDiffMeta.csv')
    ...
    df4.to_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/losersDiff_total2Meta.csv', encoding='utf-8', index=False)
