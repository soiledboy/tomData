def loseMetaDataDiff():
    ...
    df_forLoop= pd.read_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/losersmetaDataDiff_popMeta.csv')
    ...
    df_metaData.to_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/losersmetaDataDiffMeta.csv', encoding='utf-8', index=False)