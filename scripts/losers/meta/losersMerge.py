def loseMerge():
    import pandas as pd
    df1 = pd.read_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/losers_totalMeta.csv')
    df2 = pd.read_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/losersmetaDataMeta.csv')
    ...
    df4.to_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/losers_total2Meta.csv', encoding='utf-8', index=False)
