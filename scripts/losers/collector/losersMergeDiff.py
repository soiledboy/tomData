def loseMergeDiff():
    import pandas as pd
    df1 = pd.read_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/losers_totalDiffCollector.csv')
    df2 = pd.read_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/losersmetaDataDiffCollector.csv')
    ...
    df4.to_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/losersDiff_total2Collector.csv', encoding='utf-8', index=False)
