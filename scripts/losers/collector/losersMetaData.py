def loseMetaData():
    ...
    df_forLoop= pd.read_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/losersmetaData_popCollector.csv')
    ...
    df_metaData.to_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/losersmetaDataCollector.csv', encoding='utf-8', index=False)