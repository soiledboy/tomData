def loseNewActivity():
    ...
    df_old = pd.read_csv("/home/tier1marketspace/youtuberReport/scripts/data/losersDiff_total2Collector.csv")
    df_new = pd.read_csv("/home/tier1marketspace/youtuberReport/scripts/data/losers_total2Collector.csv")
    ...
    df_newActivity.to_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/losers_todayCollector.csv', encoding='utf-8', index=False)