def loseMetaDataDiff():
    ...
    df_forLoop= pd.read_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/losersmetaDataDiff_popCollector.csv')
    ...
    df_metaData.to_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/losersmetaDataDiffCollector.csv', encoding='utf-8', index=False)