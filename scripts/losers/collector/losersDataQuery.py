def loseData():
    ...
    import pandas as pd
    from queries.queryLine_loseCollector import query07
    from queries.queryLine_loseCollector import query30
    from queries.queryLine_loseCollector import query90
    from queries.queryLine_loseCollector import query180
    # 7 days
    ...
    df_lose.to_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/losers_totalCollector.csv', encoding='utf-8', index=False)

    df_forLoop = df_lose.drop_duplicates(subset='tcg_product_id', keep='first')
    df_forLoop.to_csv(r'/home/tier1marketspace/youtuberReport/scripts/data/losersmetaData_popCollector.csv', encoding='utf-8', index=False)
